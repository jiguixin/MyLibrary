...
namespace Infrastructure.Data.Ado
{
    public partial class DbExecutor : IDisposable
    {
        ...
        public static DataSet GetTables(DbProviderFactory factory, string connectionString, string sqlQuery, object parameter = null, CommandType commandType = CommandType.Text)
        {
            #region Validation
            ...
            using (var exec = new DbExecutor(conn))
            {
                return exec.GetTables(factory, sqlQuery, parameter, commandType);
            }
        } 
