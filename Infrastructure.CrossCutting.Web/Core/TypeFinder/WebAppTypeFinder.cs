...
using Infrastructure.Crosscutting.Core.TypeFinder;
using Infrastructure.CrossCutting.Web.Utility.CommomHelper;

namespace Infrastructure.CrossCutting.Web.Core.TypeFinder
{
    /// <summary>
