...
using Infrastructure.Crosscutting.ComponentModel;
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual void RestartAppDomain(string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new MyException("nopCommerce needs to be restarted due to a configuration change, but was unable to do so.\r\n" +
