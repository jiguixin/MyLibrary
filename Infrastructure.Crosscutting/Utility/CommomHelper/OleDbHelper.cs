...
namespace Infrastructure.Crosscutting.Utility.CommomHelper
{
    ...
    /// common uses of System.Data.OleDb.
    /// </summary>
    public sealed class OleDbHelper
    {
        ...
        {
            throw new NotSupportedException("Sorry, OleDB doesn't support XML.");
        }
        ...
        public static DataTable GetExcelTableName(string connStr)
        {
            try
            {
        ...
        public static List<string> GetExcelTableNameList(string connStr)
        {
            List<string> lstTables = new List<string>();
            DataTable dt = GetExcelTableName(connStr);
    ...
    /// </summary>
    internal sealed class OleDbHelperParameterCache
    {
